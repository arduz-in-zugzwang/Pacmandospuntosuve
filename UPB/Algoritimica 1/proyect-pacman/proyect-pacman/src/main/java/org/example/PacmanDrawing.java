...
public class PacmanDrawing extends JComponent {
    ...
    public PacmanDrawing(int x, int y) {
        ...
        biIzquierda = BufferedImageUtil.readImage("pacman/oeste.png", getClass());
        biArriba    = BufferedImageUtil.readImage("pacman/norte.png", getClass());
        biAbajo     = BufferedImageUtil.readImage("pacman/sur.png", getClass());
